...
if (isset($_GET['error'])) {
  switch ($_GET['error']) {
    case 1:
      echo '<script>alert("Envie Todos os dados para se autenticar.")</script>';
      echo '<script>window.location.href = "/index.php"  </script>';
      break;
      case 2:
        echo '<script>alert("Flag 5 --> FLAG")</script>';
      ...
      <div class="container">
        ...
        <div id="menu" class="collapse navbar-collapse">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a href="/register" class="nav-link"><i class="bi bi-unlock"></i>&nbsp;Registrar</a>
            </li>
            <li class="nav-item">
              <a href="#" class="nav-link disabled"><i class="bi bi-lock"></i>&nbsp;Login</a>
            </li>
          </ul>
        </div>
      </div>
