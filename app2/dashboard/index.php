    ...
    <header class="background-image">
        <nav class="navbar navbar-expand-xl navbar-light">
          <div class="container">
            ...
            <button class="navbar-toggler toggler-example button-style" type="button" data-toggle="collapse" data-target="#menu"
      ...
      <div class="container">
        <div class="row">
            <div class="col">
                <h1 class="mt-3">Bem-vindo(a) as Anotações, <?php echo $_SESSION['user'];?>!</h1>
            </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
            <div class="col">
                <header id="othercolor">
                    <nav class="navbar navbar-expand-xl navbar-light">
                        <div class="collapse navbar-collapse">
                            <ul class="navbar-nav ml-auto">
                              <li class="nav-item">
                                  <form action="/create_note">
                                    <button type="submit" class="btn btn-success">Nova anotação</button>
                                  </form>
                              </li>
                              <li class="nav-item">
                                <form action="/notas/">
                                  <button type="submit" class="btn btn-secondary">Ver suas anotações</button>
                                </form>
                              </li>
                            </ul>
                          </div>
